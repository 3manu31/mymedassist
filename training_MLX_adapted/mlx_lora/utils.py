...
def load(path_or_hf_repo: str, tokenizer_config={}):
    ...
    try:
        ...
        print("Warning:", e)
        print("Attempting to ignore extra parameters and continue...")
        # Use model._parameters.keys() to filter only matching parameters
        model_params = set(model._parameters.keys())
